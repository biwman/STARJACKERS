...
public static class BlueprintCatalog
{
    ...
    static readonly BlueprintTradeOffer[] MissEnigmaOffers =
    {
        ...
        Offer(InventoryItemCatalog.TetherHarpoonId, InventoryItemCatalog.TractorBeamId, InventoryItemCatalog.PirateFighterSalvageId),
        Offer(InventoryItemCatalog.HackingDeviceId, InventoryItemCatalog.RadarShipSalvageId, InventoryItemCatalog.DroidScrapId),
        Offer(InventoryItemCatalog.BioTrapId, InventoryItemCatalog.RescueShipSalvageId, InventoryItemCatalog.SpaceAnimalRemainsId),
        Offer(InventoryItemCatalog.AsteroidBreacherBombId, InventoryItemCatalog.SpaceBombId, InventoryItemCatalog.SpaceMineWreckId),
        Offer(InventoryItemCatalog.BlackMarketThrusterId, InventoryItemCatalog.PirateFighterSalvageId, InventoryItemCatalog.PlatinumChunkId),
        ...
        ScrapOffer(InventoryItemCatalog.LootHookId, 4),
        ScrapOffer(InventoryItemCatalog.StasisBuoyId, 4),
        ScrapOffer(InventoryItemCatalog.SpaceTorpedoId, 4),
        ScrapOffer(InventoryItemCatalog.MetalDriftWallId, 4),
        ScrapOffer(InventoryItemCatalog.OverclockedMagazineId, 3),
    ...
    static readonly WreckBlueprintDropRule[] WreckBlueprintDropRules =
    {
        WreckRule(InventoryItemCatalog.DroidScrapId,
            ...
            Drop(InventoryItemCatalog.OverclockedMagazineId, 0.005f),
            Drop(InventoryItemCatalog.LootHookId, 0.0045f),
        ...
        WreckRule(InventoryItemCatalog.SpaceMineWreckId,
            ...
            Drop(InventoryItemCatalog.StasisBuoyId, 0.0052f),
            ...
            Drop(InventoryItemCatalog.SpaceTorpedoId, 0.003f),
            Drop(InventoryItemCatalog.AsteroidBreacherBombId, 0.0026f),
        ...
        WreckRule(InventoryItemCatalog.SpaceTruckWreckId,
            ...
            Drop(InventoryItemCatalog.MetalDriftWallId, 0.0034f)),
        WreckRule(InventoryItemCatalog.ContainerShipWreckId,
            ...
            Drop(InventoryItemCatalog.MetalDriftWallId, 0.0044f)),
        ...
        WreckRule(InventoryItemCatalog.RadarShipSalvageId,
            ...
            Drop(InventoryItemCatalog.HackingDeviceId, 0.0038f),
        ...
        WreckRule(InventoryItemCatalog.RescueShipSalvageId,
            ...
            Drop(InventoryItemCatalog.BioTrapId, 0.0034f),
        ...
        WreckRule(InventoryItemCatalog.PirateFighterSalvageId,
            ...
            Drop(InventoryItemCatalog.AutoTurretId, 0.0055f),
            Drop(InventoryItemCatalog.LootHookId, 0.0048f),
            Drop(InventoryItemCatalog.TetherHarpoonId, 0.0038f),
            ...
            Drop(InventoryItemCatalog.BlackMarketThrusterId, 0.0024f),
        ...
        WreckRule(InventoryItemCatalog.PirateBaseCoreId,
            ...
            Drop(InventoryItemCatalog.HackingDeviceId, 0.0042f),
            Drop(InventoryItemCatalog.DoubleEngineId, 0.004f),
            Drop(InventoryItemCatalog.TetherHarpoonId, 0.0038f),
            Drop(InventoryItemCatalog.SpaceTorpedoId, 0.0038f),
            Drop(InventoryItemCatalog.AsteroidBreacherBombId, 0.0034f),
            Drop(InventoryItemCatalog.MetalDriftWallId, 0.0036f),
            Drop(InventoryItemCatalog.BlackMarketThrusterId, 0.0032f),
        ...
        WreckRule(InventoryItemCatalog.MothershipCoreId,
            ...
            Drop(InventoryItemCatalog.HackingDeviceId, 0.004f),
            Drop(InventoryItemCatalog.CloakDeviceId, 0.0038f),
            Drop(InventoryItemCatalog.BioTrapId, 0.0036f),
            Drop(InventoryItemCatalog.AsteroidBreacherBombId, 0.0035f),
            Drop(InventoryItemCatalog.BlackMarketThrusterId, 0.0032f),
